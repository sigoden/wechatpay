...
export interface PayBankResponseCommon {
  /**
   * 商户appid
...
export interface PayBankResponseFail extends PayBankResponseCommon {}

export interface PayBankResponseSuccess extends PayBankResponseCommon {
  /**
   * 商户订单号
